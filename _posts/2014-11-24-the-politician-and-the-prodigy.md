...
![Nadeem and Ali opening big.png](/_posts/Nadeem and Ali opening big.png)  Buddies Ali Mohammad and Nadeem Mazen became business partners in May 2011, when they opened danger!awesome, a workshop in Cambridge. There, trained technicians and customers alike can cut and engrave anything from pint glasses to toilet seats using blazing lasers. 
...
That’s why, in addition to being a work-for-hire shop with professional technicians who fulfill orders, the shop offers a membership program to customers who want to use the laser cutters themselves.

Besides the $125 training session, the membership fees are relatively cheap. Unlike TechShop, a member-based workshop that requires a monthly membership, danger!awesome offers a pay-as-you-go option. Members who choose this plan only pay three dollars per minute spent using the laser cutter itself, not the computer’s design software. Creating and formatting the image on the computer can take hours, but once it’s sent to the machine, the laser beam does its job in mere minutes. To make the process even more affordable, members bring their own materials, like wood, leather and acrylic.

Ali and Nadeem’s efforts to engage the community with high-tech tools seem to be working, at least to some extent. In fact, Danger!awesome has so many supporters that they had to host two opening nights for the new space, which was funded with a $42,727 donation from 727 backers on [Kickstarter](https://www.kickstarter.com/projects/nadeemtron/dangerawesome-a-high-tech-hands-on-community-maker). And to think, it was a vision of dancing toasts that started it all. 

## Dancing Toasts

It was during Ramadan in 2009 when Nadeem and Ali had the conversation that would change their lives. While waiting for sundown, when their daylong fasts would end, they found themselves talking about food.
...
It turned out that Kalush wanted to run with it too. He requested a prototype, so Ali and Nadeem took to the labs in the depths of MIT to play with laser cutters.

They’d independently taught themselves to use the box-shaped machines that resemble copier machines. The duo experimented with bread until they perfected the routine. They’d format each design in the computer software, position the soft slice of white bread under the laser, close the lid, and press the green button. Then they’d pop each slice into a cheap toaster until it reached a golden brown and film the sequence of toasts using stop motion video.

Because Nadeem and Ali were MIT grad students, they had access to the university’s laser cutters. But that didn’t mean they had permission to use them for their own extracurricular projects. 
...
Eight sleep-deprived days, 2,430 slices of bread, and countless cookies later, the video was posted on YouTube. It immediately went viral. A couple years later, Ali and Nadeem opened danger!awesome—a career move neither had anticipated when they first met.
...
Nadeem never did get into robotics. He realized that, regardless of his job title, he’s meant to make things and solve problems. He’s tackled the problem of under-advocated issues at Nimblebot, community engagement with high-tech learning at danger!awesome, and local issues through City Council. 

“I'm just kind of one guy trifurcated trying to do three things, and I see the next step as figuring out how to make those things roll on their own while I focus on, ideally, one of them,” Nadeem says. 
...
Nadia doesn’t think either of them have many inhibitions, which is probably why danger!awesome worked out. The scrappy pair created the start-up through their resources and know-how alone, Nejad says. 

After the OK Go video, Nadeem and Ali stored the three laser cutters in a studio on Green Street, but were forced to move out when the landlord didn’t renew their lease. “I had this image of a laser cutter in my living room,” Ali says. 

After finding an open retail space around the corner from the Central Square T-stop, the pair decided to turn their personal studio into a full-blown business. Ali and his younger sister came up with the name. They thought it would be funny if the place were so awesome that it’s dangerous. 
...
With their bright minds and elite degrees, Ali and Nadeem are clearly eligible for highly lucrative jobs. Instead, they’re committed to sharing the high-tech tools they’ve been privileged to use with people outside the four-block radius of MIT.
